...
public class ProductRequestDtoValidator : AbstractValidator<ProductRequestDto>
{
    public ProductRequestDtoValidator()
    {
        RuleFor(p => p.Name)
            ...
            .Length(2, 100)
            .WithMessage(
                "The length of {PropertyName} must be between 2 and 100 characters. The current length is {TotalLength}")
        ...
        RuleFor(p => p.Description)
            ...
            .Length(10, 500)
            .WithMessage(
                "The length of {PropertyName} must be between 10 and 500 characters. The current length is {TotalLength}")
